...
let xssCode = null;
if (prod) {
  const order = await call("/api/order", "POST", { businessId: 1, customerName: "TEST XSS <img src=x onerror=alert(1)>", customerPhone: "0551234567", fulfillmentType: "PICKUP", items: [{ inventoryId: prod.id, quantity: 1 }] });

    ...
    <div className="min-h-screen bg-slate-100 text-slate-900">
      ...
      <header className="bg-[#131921] text-white sticky top-0 z-40 shadow-lg" data-testid="oo-header">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 pt-2.5 pb-2 flex flex-wrap items-center gap-x-3 gap-y-2">
          {/* Logo → GoMina 360 sign-in (one click, desktop + mobile).
              Pure navigation: it never touches cart/order state. */}
          <Link
            href="/"
            className="flex items-center gap-2 shrink-0 rounded-lg -m-1 p-1 cursor-pointer hover:opacity-90 active:opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 touch-manipulation"
            data-testid="oo-logo"
            title="Go to GoMina 360 Login"
